    ...
    $.post("/qr/", {
        ...
        for (var row in data) {
            ...
            markers[i].addListener('click', function () {
                mostrarInmueble(JSON.stringify(fields));
            });
...
function mostrarInmueble(fields) {
    var modal = $("#modal_inmueble");
    ...
    title.html(fields.tipo_inmueble + " EN " + fields.barrio + " " + fields.direccion);
